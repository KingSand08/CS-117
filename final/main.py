...
print("------------------------------\nK-NN MODEL:")
# knn_model = knn_builder(23, 'distance', 2)      #68%
...
# voting_model = build_ensemble_voting((35,51), 'tanh', 'adam', 127, 64, 3, 0.257857374573552, 0.0804721184915089, 23,'distance', 2, 0)         #70
...
# dl_bagging_model = build_ensemble_bagging_dl(155, (18,89), 'relu', 'adam', 129, 64, 5, 0.21328077721644959, 0.07750785574909076, 0)         #80%
